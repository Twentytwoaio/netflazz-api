<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/ai4.php";

// Data yang akan dikirimkan via POST
$data = [
    'api_key' => 'xxxxxxxxxxxxxxxxxxxxx',      // Ganti dengan API Key Anda
    'secret_key' => 'xxxxxxxxxxxxxxxxxxxxx',  // Ganti dengan Secret Key Anda
    'action' => 'korosAi',        // Action Jangan Diubah
    'url_img' => 'https://example.com/korosai.jpg', // Ganti dengan url gambar yang ingin diubah
    'text' => 'jelaskan tentang foto itu?' // Ganti dengan pertanyaan mengenai foto yang dikirimkan
];
