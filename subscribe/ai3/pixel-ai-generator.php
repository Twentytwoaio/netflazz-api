<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/ai3.php";

// Data yang akan dikirimkan via POST
$data = [
    'api_key' => 'xxxxxxxxxxxxxxxxxxxxx',      // Ganti dengan API Key Anda
    'secret_key' => 'xxxxxxxxxxxxxxxxxxxxx',  // Ganti dengan Secret Key Anda
    'action' => 'pixelGenerator',        // Action Jangan Diubah
    'prompt' => 'wanita sedang memegang handphone' // Ganti dengan prompt gambar anda
];
