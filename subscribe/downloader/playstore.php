<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/downloader.php";

// Data yang akan dikirimkan via POST
$data = [
    'api_key' => 'xxxxxxxxxxxxxxxxxxxxx',      // Ganti dengan API Key Anda
    'secret_key' => 'xxxxxxxxxxxxxxxxxxxxx',  // Ganti dengan Secret Key Anda
    'action' => 'playstore',        // Action Jangan Diubah
    'url' => 'https://play.google.com/store/apps/details?id=xxxx' // Ganti dengan url playstore anda
];
