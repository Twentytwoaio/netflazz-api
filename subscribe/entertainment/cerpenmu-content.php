<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/entertainment.php";
...
$data = [
    ...
    'action' => 'cerpenmuContent',        // Action Jangan Diubah
    'url' => 'http://cerpenmu.com/xxxx'  // Ganti dengan url cerpenmu yang sudah diambil
];
