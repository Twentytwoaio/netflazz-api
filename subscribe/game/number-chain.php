<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/game.php";

// Data yang akan dikirimkan via POST
$data = [
    'api_key' => 'xxxxxxxxxxxxxxxxxxxxx',      // Ganti dengan API Key Anda
    'secret_key' => 'xxxxxxxxxxxxxxxxxxxxx',  // Ganti dengan Secret Key Anda
    'action' => 'numberchain',        // Action Jangan Diubah
    'start' => '150',           // Ganti dengan awalan nilai
    'show' => '10'              // Ganti dengan berapa soal yang ingin di tampilkan
];
