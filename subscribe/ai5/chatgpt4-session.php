<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/ai5.php";

// Data yang akan dikirimkan via POST
$data = [
    'api_key' => 'xxxxxxxxxxxxxxxxxxxxx',      // Ganti dengan API Key Anda
    'secret_key' => 'xxxxxxxxxxxxxxxxxxxxx',  // Ganti dengan Secret Key Anda
    'action' => 'chatGpt4-session',        // Action Jangan Diubah
    'session' => '84987429805', // ganti dengan session anda untuk mempertahankan pertanyaan 
    'text' => 'apa itu ppob?' // Ganti dengan pertanyaan anda
];
