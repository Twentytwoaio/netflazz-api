...
$data = [
    ...
    'action' => 'textTOspeech',        // Action Jangan Diubah
    'text' => 'Netflazz adalah pusat server connection terbesar di indonesia',        // Ubah dengan text anda
    'gender' => 'female'        // Ubah untuk gender suara (male/female)
];
