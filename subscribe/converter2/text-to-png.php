<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/converter2.php";

// Data yang akan dikirimkan via POST
$data = [
    'api_key' => 'xxxxxxxxxxxxxxxxxxxxx',      // Ganti dengan API Key Anda
    'secret_key' => 'xxxxxxxxxxxxxxxxxxxxx',  // Ganti dengan Secret Key Anda
    'action' => 'textTOpng',        // Action Jangan Diubah
    'text' => 'NetFlazz COM',        // Ubah dengan text anda
    'size' => '50',        // Ubah untuk ukuran text
    'color' => 'red' // Ganti dengan warna text (gunakan pemilihan warna dengan bahasa inggris atau dengan HEX Hexadecimal)
];
