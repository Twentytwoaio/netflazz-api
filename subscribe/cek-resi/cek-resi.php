<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/cek-resi.php";

// Data yang akan dikirimkan via POST
$data = [
    'api_key' => 'xxxxxxxxxxxxxxxxxxxxx',      // Ganti dengan API Key Anda
    'secret_key' => 'xxxxxxxxxxxxxxxxxxxxx',  // Ganti dengan Secret Key Anda
    'action' => 'cek',            // Action Jangan Diubah
    'code' => 'spx',    // Ganti dengan kode expedisi
    'awb' => 'SPXIDxxxxxx' // Ganti dengan resi anda
];
