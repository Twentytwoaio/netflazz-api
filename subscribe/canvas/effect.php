...
$data = [
    ...
    'action' => 'effect',        // Action Jangan Diubah
    'style' => 'greyscale', // Ganti dengan style efek (greyscale, invert, sephia, threshold, trigger)
    'url_img' => 'https://example.com/effect.jpg' // Ganti dengan url gambar yang ingin diubah
];
