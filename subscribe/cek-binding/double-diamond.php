<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/cek-binding.php";

// Data yang akan dikirimkan via POST
$data = [
    'api_key' => 'xxxxxxxxxxxxxxxxxxxxx',      // Ganti dengan API Key Anda
    'secret_key' => 'xxxxxxxxxxxxxxxxxxxxx',  // Ganti dengan Secret Key Anda
    'action' => 'mlbb-double-diamond',        // Action Jangan Diubah
    'userid' => 'xxxxxxxxxx',        // Ganti dengan User ID akun Mobile Legends Anda
    'zoneid' => 'xxxxx'        // Ganti dengan Zone ID akun Mobile Legends Anda
];
