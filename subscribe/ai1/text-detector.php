<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/ai.php";

// Data yang akan dikirimkan via POST
$data = [
    'api_key' => 'xxxxxxxxxxxxxxxxxxxxx',      // Ganti dengan API Key Anda
    'secret_key' => 'xxxxxxxxxxxxxxxxxxxxx',  // Ganti dengan Secret Key Anda
    'action' => 'detector',        // Action Jangan Diubah
    'text' => 'Masukan text atau artikel yang ingin dilakukan pengecekan' // Text yang ingin di lakukan pengecekan
];
