<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/email-temporary";
...
$data = [
    ...
    'action' => 'readEmail',                   // Action untuk membaca email
    'email' => 'random123@mail.com',          // Ganti dengan email yang sudah dibuat
    'sid_token' => 'xxxxxxxxxxxxxxxxxxx'      // Ganti dengan token yang didapat saat create email
];
