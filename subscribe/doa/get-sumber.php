<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/doa.php";

// Data yang akan dikirimkan via POST
$data = [
    'api_key' => 'xxxxxxxxxxxxxxxxxxxxx',      // Ganti dengan API Key Anda
    'secret_key' => 'xxxxxxxxxxxxxxxxxxxxx',  // Ganti dengan Secret Key Anda
    'action' => 'sumber',        // Action Jangan Diubah
    'kategori' => 'hadits' // Ganti dengan kategori yang ingin dimunculkan, nilai kategori didapat pada list sumber
];
