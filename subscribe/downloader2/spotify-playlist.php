<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/downloader2.php";

// Data yang akan dikirimkan via POST
$data = [
    'api_key' => 'xxxxxxxxxxxxxxxxxxxxx',      // Ganti dengan API Key Anda
    'secret_key' => 'xxxxxxxxxxxxxxxxxxxxx',  // Ganti dengan Secret Key Anda
    'action' => 'spotifyPlaylist',        // Action Jangan Diubah
    'url' => 'https://open.spotify.com/playlist/xxxx' // Ganti dengan url playlist spotify anda
];
