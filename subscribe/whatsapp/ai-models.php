<?php
// Sample request for action: ai-models
...
$data = [
    ...
    'action'     => 'ai-models',
    // tidak ada parameter tambahan untuk action ini
];

// Keterangan parameter tambahan:
// Endpoint ini tidak membutuhkan parameter tambahan selain api_key & secret_key.
Mengembalikan daftar model ChatGPT, Gemini, Claude, dan DALL·E yang tersedia.
