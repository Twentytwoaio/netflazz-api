<?php
// Sample request for action: set-webhook
...
$data = [
    ...
    'action'     => 'set-webhook',
    'sender'  => '62888xxxxxxx',
    'webhook' => 'https://example.com/webhook-wa-baru',
];

// Keterangan parameter tambahan:
// sender  : nomor device yang akan di-update webhook-nya
webhook : URL webhook baru untuk menerima event
