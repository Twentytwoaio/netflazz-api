<?php
// Sample request for action: generate-qr
...
// device : nomor device yang akan digenerate QR login-nya
force  : (opsional) true/false, jika true maka akan buat device jika belum ada
