<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/cek-status-server";
...
$data = [
    ...
    'action' => 'cek',              // Action untuk cek status server
    'kategori' => 'Cek Account',                // Filter berdasarkan kategori (opsional)
    'api' => 'Region',                          // Filter berdasarkan nama api/code (opsional)
    'status' => 'Aktif'                          // Filter berdasarkan status (opsional)
];
