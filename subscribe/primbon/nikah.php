<?php
// URL API Anda
$url = "https://api.nf22.my.id/subscribe/primbon.php";
...
$data = [
    ...
    'action' => 'nikah',        // Action Jangan Diubah
    'tanggal' => '22',   // Ganti dengan tanggal nikah anda
    'bulan' => '1',   // Ganti dengan bulan nikah anda
    'tahun' => '2024'   // Ganti dengan tahun nikah anda
];
